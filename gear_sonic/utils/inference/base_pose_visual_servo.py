...
and always detects the supporting surface with the fixed text prompt ``desk``.
...
class YoloePersistentTracker:
    ...
    def start_target(
        ...
        *,
        ...
        """Install a visual target plus the fixed text surface ``desk``."""
        import torch
        ...
        surface_embedding = self.model.get_text_pe([TABLE_TEXT_PROMPT])
    ...
    try:
        while not stop_event.is_set():
            ...
            try:
                ...
                if surface is None:
                    raise RuntimeError(
                        f"YOLOE found no instance for fixed prompt {TABLE_TEXT_PROMPT!r}"
                    )
                ...
                _write_json(
                    output_dir / "tracking_ids.json",
                    {
                        ...
                        "target_prompt": spec.target_prompt,
                        "surface_prompt": TABLE_TEXT_PROMPT,
                        "table_bboxes": [],

...
class SimulatorFactory:
    ...
    def _create_mujoco_simulator(config: Dict[str, Any], env_name: str = "default", **kwargs):
        ...
        return BaseSimulator(
            ...
            show_smpl_tracking=kwargs.get("show_smpl_tracking", False),
            smpl_tracking_host=kwargs.get("smpl_tracking_host", "localhost"),
            smpl_tracking_port=kwargs.get("smpl_tracking_port", 5556),
            config=config,
            env_name=env_name,

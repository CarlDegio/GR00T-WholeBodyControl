...
Usage (from repo root):
    ...
    python -m gear_sonic.utils.data_collection.service --task-prompt "walk forward" --dataset-name my_session
"""
...
class GrootDataCollector:
    ...
    def __init__(
        ...
        sonic_data_zmq_host: str,
        sonic_data_zmq_port: int,
        text_to_speech=None,
        frequency: int = 20,
    ):
...
def main(config: SonicDataExporterConfig):
    ...
    sonic_endpoint = profile.endpoint("cpp_command")
    ...
    try:
        ...
        data_collector = GrootDataCollector(
            ...
            sonic_data_zmq_host=sonic_endpoint.host,
            sonic_data_zmq_port=sonic_endpoint.port,

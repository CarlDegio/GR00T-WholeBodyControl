...
from gear_sonic.runtime.control_gateway import ControlGatewayCore, OperatorConsoleRouter
...
def main() -> None:
    ...
    address = profile.endpoint("control_gateway_intent")
    endpoint = f"tcp://{args.host or address.host}:{args.port or address.port}"
    ...
    print(
        ...
        "PLANNER: w/a/s/d/q/e/n/space (single-key, no Enter); "

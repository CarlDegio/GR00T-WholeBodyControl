...
def test_vla_stats_report_unique_rates_throughput_and_latency():
    ...
    assert summary["encoded_streams"]["ego_view"]["unique_fps"] == 0.5
    assert summary["decoded_streams"]["ego_view_depth"]["unique_fps"] == 0.5
    assert summary["decoded_images_per_second"] == 1.0
